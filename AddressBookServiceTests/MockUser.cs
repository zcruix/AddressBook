...
namespace AddressBookServiceTests
{
    ...
    {
        public static IUser LoggedInTestableUser(IAddressBookService addressBookService, string username, string validpassword)
        {
        ...
        public static IUser AddTestableUser(IAddressBookService addressBookService, string username, string validpassword)
        {
            var user = new User
            {
                UserCredential = GetTestableUserCredentials(username, validpassword)
